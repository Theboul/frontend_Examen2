    ...
    >
      ...
      >
        <table className="min-w-full text-sm text-center border-collapse">
          ...
          >
            <tr>
              <th className="py-2 px-3 whitespace-nowrap">ID Materia</th>
              <th className="whitespace-nowrap">ID Semestre</th>
              <th className="whitespace-nowrap">ID Carrera</th>
              <th className="whitespace-nowrap">Nombre</th>
              <th className="whitespace-nowrap">Sigla</th>
              <th className="whitespace-nowrap">Creditos</th>
            </tr>
          </thead>
